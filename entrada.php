...
<nav class="navbar navbar-expand-sm navbar-dark px-0" id="navegacion">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item">
        <a class="nav-link disabled" href="#">Entrada</a>
      </li>
      <li class="nav-item">
...
<div class="container">
  <h2>Entrada</h2>
  <p>Realiza un entrada de Producto</p>         
...
<div class="form-inline">
   ...
   <!--PROVEDORES --> 
    ...
    <div class="input-group mb-4 mr-lg-3">
      ...
      <select name="proveedorp" class="selecciona" id="categoriaproducto" required>
      ...
      <?php
                    ...
                    foreach($db->query('SELECT nombreProveedor FROM proveedores') as $row) {
                        echo' <option value= '.$row['nombreProveedor'].'>
                        '.$row['nombreProveedor'].'
                        '; }
                        ?>  </option>
